      ...
      <div className="page-container">
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-3 items-start sm:items-center justify-between">
          ...
          <nav className="flex items-center gap-x-4 gap-y-1 flex-wrap text-xs text-ink-muted">
            <Link to="/privacy" className="hover:text-teal transition-colors" data-testid="footer-privacy-link">Privacy</Link>
            <Link to="/terms" className="hover:text-teal transition-colors" data-testid="footer-terms-link">Terms</Link>
            <Link to="/imprint" className="hover:text-teal transition-colors" data-testid="footer-imprint-link">Imprint</Link>
            <Link to="/data-rights" className="hover:text-teal transition-colors" data-testid="footer-data-rights-link">Data rights</Link>
            <Link to="/remove" className="hover:text-teal transition-colors" data-testid="footer-removal-link">Removal request</Link>
            <button
