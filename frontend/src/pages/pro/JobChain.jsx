...
export function stepStates(job = {}, quote = null) {
  ...
  /* "Now" is the first unfinished step *after the last finished one*, not the
     ...
     behind it — booked over the phone — and taking the first gap made that
     page claim the pro was at step 1 while step 2 was already ticked. A chain
     that goes done-after-now reads as broken. The skipped step keeps its own
     state and stays white, which is the truth: there is no quote here.
