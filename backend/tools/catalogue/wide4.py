...
FAHRZEUGE = [
    J(key="kfz.service_klein", messy=False, trade="kfz", group="Fahrzeuge",
    ...
    J(key="kfz.reifenwechsel", messy=False, trade="kfz", group="Fahrzeuge",
    ...
    J(key="fahrrad.service", messy=False, trade="fahrrad", group="Fahrzeuge",
